...
import yvonneskitchen.tinymce.settings
...
class TinyMCE(forms.Textarea):
    ...
    def render(self, name, value, attrs=None):
        ...
        mce_config = yvonneskitchen.tinymce.settings.DEFAULT_CONFIG.copy()
        mce_config.update(get_language_config(self.content_language))
        if yvonneskitchen.tinymce.settings.USE_FILEBROWSER:
        ...
        if yvonneskitchen.tinymce.settings.USE_COMPRESSOR:
            compressor_config = {
    ...
    def _media(self):
        if yvonneskitchen.tinymce.settings.USE_COMPRESSOR:
            ...
            js = [yvonneskitchen.tinymce.settings.JS_URL]
        if yvonneskitchen.tinymce.settings.USE_FILEBROWSER:
...
def get_language_config(content_language=None):
    ...
    if yvonneskitchen.tinymce.settings.USE_SPELLCHECKER:
